const { getAllPatient, addPatient, getPatient, deletePatient, updatePatient, detailPatient, searchPatient, exportPatient } = require("../controllers/patient.controller");
