  ...
  try {
    const result = await sequelize.transaction(async (t) => {
      const Patients = await sequelize.query(
        `select Pa.id_patient, nom_patient, postnom_patient, date_naissance_patient as date_naissance, prenom_patient, Pa.sexe_patient, Anthr.type_malnutrition, Date_Consultation as date_Consultation, Pa.transferer_unt,  Pa.declarer_gueri, nom_user as nom_consultant, postnom_user as postnom_consultant  from
        patients as Pa
        inner join ( 
