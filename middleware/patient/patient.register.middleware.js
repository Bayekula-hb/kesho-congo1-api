...
patientRegisterMiddleware.use(
  [
    ...
    body("peri_brachail").notEmpty().withMessage("Cannot be empty"),
    ...
    body("type_status_marital").notEmpty().withMessage("Cannot be empty"),
    body("status_marital").notEmpty().withMessage("Cannot be empty"),
