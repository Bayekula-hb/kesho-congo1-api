...
const validationData =  [
  ...
  body("type_malnutrition").notEmpty().withMessage("Cannot be empty").matches(/[A-Za-z]{4,}/).withMessage("la taille inférieur à 4"),
  ...
  body("contraception_mere").matches(/[A-Za-z]{8,}/).withMessage("la taille inférieur à 4"),
