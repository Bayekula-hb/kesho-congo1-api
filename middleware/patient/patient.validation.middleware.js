...
const validationData =  [
  ...
  body("age_mere").notEmpty().withMessage("Cannot be empty").matches(/\d{2,3}/).withMessage("pas de lettres"),
  body("scolarite_mere").notEmpty().withMessage("Cannot be empty").isDate().withMessage("date not validated"),
  ...
  body("statut_marital").notEmpty().withMessage("Cannot be empty"),
  body("nbre_femme_pere").notEmpty().withMessage("Cannot be empty").matches(/\d{2,3}/).withMessage("pas de lettres"),
