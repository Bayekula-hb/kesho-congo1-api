...
const validationData =  [
  ...
  body("tbc").notEmpty().withMessage("Cannot be empty").isBoolean().withMessage("c'est un champ boolean"),
  body("atcd_du_tbc_dans_fratrie").notEmpty().withMessage("Cannot be empty").isBoolean().withMessage("c'est un champ boolean"),
  body("hospitalisation_recente").notEmpty().withMessage("Cannot be empty").isBoolean().withMessage("c'est un champ boolean"),
  ...
  body("poids").notEmpty().withMessage("Cannot be empty").matches(/\d{1,4}/).withMessage("pas de lettres"),
  body("taille").notEmpty().withMessage("Cannot be empty").matches(/\d{1,4}/).withMessage("pas de lettres"),
  body("type_malnutrition").notEmpty().withMessage("Cannot be empty").matches(/[A-Za-z]{3,4}/).withMessage("la taille inférieur à 4"),
  body("type_statut_marital").notEmpty().withMessage("Cannot be empty").matches(/[A-Za-z]{4,}/).withMessage("la taille inférieur à 4"),
  body("statut_marital").notEmpty().withMessage("Cannot be empty").matches(/[A-Za-z]{4,}/).withMessage("la taille inférieur à 4"),
  body("nom_patient").notEmpty().withMessage("Cannot be empty").matches(/[A-Za-z]{4,}/).withMessage("la taille inférieur à 4"),
  body("postnom_patient").notEmpty().withMessage("Cannot be empty").matches(/[A-Za-z]{4,}/).withMessage("la taille inférieur à 4 et pas de chiffres"),
  body("prenom_patient").notEmpty().withMessage("Cannot be empty").matches(/[A-Za-z]{4,}/).withMessage("la taille inférieur à 4 et pas de chiffres"),
  body("sexe_patient").notEmpty().withMessage("Cannot be empty").matches(/[M|F]{1,1}$/).withMessage("type de sexe non connu"),
  body("provenance_patient").notEmpty().withMessage("Cannot be empty"),
  body("poids_naissance").notEmpty().withMessage("Cannot be empty").matches(/\d{1,3}/).withMessage("pas de lettres"),
  body("diversification_aliment").notEmpty().withMessage("Cannot be empty"),
  body("telephone").notEmpty().withMessage("Cannot be empty").isMobilePhone().withMessage("numéro non valide"),
  body("adresse_patient").notEmpty().withMessage("Cannot be empty"),
  body("vivre_deux_parents").notEmpty().withMessage("Cannot be empty").isBoolean().withMessage("c'est un champ boolean"),
  body("mere_enceinte").notEmpty().withMessage("Cannot be empty").isBoolean().withMessage("c'est un champ boolean"),
  body("mere_en_vie").notEmpty().withMessage("Cannot be empty").isBoolean().withMessage("c'est un champ boolean"),
  body("pere_en_vie").notEmpty().withMessage("Cannot be empty").isBoolean().withMessage("c'est un champ boolean"),
  ...
  body("age_mere").notEmpty().withMessage("Cannot be empty").isDate().withMessage("date not validated"),
  ...
  body("contraception_naturelle").matches(/[A-Za-z]{4,}/).withMessage("la taille inférieur à 4"),
  body("contraception_moderne").matches(/[A-Za-z]{4,}/).withMessage("la taille inférieur à 4"),
  ...
  body("consommation_poisson").notEmpty().withMessage("Cannot be empty").isBoolean().withMessage("c'est un champ boolean"),
  ...
  body("nom_tuteur").notEmpty().withMessage("Cannot be empty").matches(/[A-Za-z]{4,}/).withMessage("la taille inférieur à 4"),
  body("taille_menage").notEmpty().withMessage("Cannot be empty").matches(/\d{1,3}/).withMessage("pas de lettres"),
  body("tbc_parents").notEmpty().withMessage("Cannot be empty").isBoolean().withMessage("c'est un champ boolean"),
  body("calendrier_vaccinal").notEmpty().withMessage("Cannot be empty"),
  body("vaccin_non_recu").notEmpty().withMessage("Cannot be empty").matches(/[A-Za-z]{3,}/).withMessage("la taille inférieur à 4"),
  body("duree_produit_plante").notEmpty().withMessage("Cannot be empty").matches(/\d{1,7}/).withMessage("pas de lettres"),
  body("date_naissance_patient").notEmpty().withMessage("Cannot be empty").isDate().withMessage("date not validated"),
  body("date_naissance_tuteur").notEmpty().withMessage("Cannot be empty").isDate().withMessage("date not validated"),
  body("allaitement_6mois").notEmpty().withMessage("Cannot be empty").isBoolean().withMessage("c'est un champ boolean"),
